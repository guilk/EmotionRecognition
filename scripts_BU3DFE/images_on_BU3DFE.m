...
[bu3d_feature, bu3d_label] = prepare_BU3DFE_data(bu3dfe_root, samples, train_inds);
...
for i = 1:num_folds
    ...
    [tr_feature,tr_label] = prepare_Bosphorus_data(bosphorus_root, samples, train_inds);
    tr_features = [ck_feature; bu3d_feature; tr_feature];
    tr_labels = [ck_label; bu3d_label; tr_label];
